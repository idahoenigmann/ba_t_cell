...
FFT transforms temporal data into a representation consisting of the sum of sines. From this we can directly see which frequencies are contained in the data with which amplitudes.
