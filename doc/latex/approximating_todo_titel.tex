...
The other conditions are met as $k_1 \in [0.05, 10] \implies k_1 > 0$ while $k_2 \in [-1, -0.01] \implies k_2 < 0$. The condition $d \leq a$ and $w_1 \leq w_2$ can be checked after an approximation has been found and used to reject some approximations.
